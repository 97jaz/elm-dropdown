...
var _user$project$Dropdown_Types$Model = F2(
	function (a, b) {
		return {rootItemPosition: a, focusState: b};
	});
var _user$project$Dropdown_Types$Config = F7(
	function (a, b, c, d, e, f, g) {
		return {optionHtml: a, optionString: b, groupHtml: c, groupString: d, selectionHtml: e, selectionString: f, isSelected: g};
	});
var _user$project$Dropdown_Types$ViewMethods = F5(
	function (a, b, c, d, e) {
		return {cssClass: a, placeholder: b, search: c, selectAll: d, items: e};
	});
var _user$project$Dropdown_Types$UpdateMethods = function (a) {
	return {closeOnSelect: a};
};
var _user$project$Dropdown_Types$Group = F2(
	function (a, b) {
		return {ctor: 'Group', _0: a, _1: b};
	});
var _user$project$Dropdown_Types$Option = function (a) {
	return {ctor: 'Option', _0: a};
};
var _user$project$Dropdown_Types$Open = function (a) {
	return {ctor: 'Open', _0: a};
};
var _user$project$Dropdown_Types$Focused = {ctor: 'Focused'};
var _user$project$Dropdown_Types$Blurred = {ctor: 'Blurred'};
var _user$project$Dropdown_Types$Highlight = function (a) {
	return {ctor: 'Highlight', _0: a};
};
var _user$project$Dropdown_Types$Initial = {ctor: 'Initial'};
var _user$project$Dropdown_Types$ItemPosition = F2(
	function (a, b) {
		return {ctor: 'ItemPosition', _0: a, _1: b};
	});
var _user$project$Dropdown_Types$Node = F4(
	function (a, b, c, d) {
...
var _user$project$Dropdown_Types$FocusStateMsg = function (a) {
...
var _user$project$Dropdown_Zipper$up = function (_p3) {
	var _p4 = _p3;
	var _p5 = _p4._1;
	if (_p5.ctor === 'Node') {
		return _elm_lang$core$Maybe$Just(
...
var _user$project$Dropdown_Zipper$nextUp = function (pos) {
	return A2(
		...
		_user$project$Dropdown_Zipper$up(pos));
};
...
var _user$project$Dropdown_Zipper$rightmostSibling = function (pos) {
	return A2(
...
var _user$project$Dropdown_Zipper$bottomRight = function (pos) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		pos,
		A2(
...
var _user$project$Dropdown_Common_Update$modelOnSelect = F2(
	function (methods, model) {
		return methods.closeOnSelect ? _elm_lang$core$Native_Utils.update(
			model,
			{focusState: _user$project$Dropdown_Types$Focused}) : model;
	});
var _user$project$Dropdown_Common_Update$update = F4(
	function (methods, config, msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'NoOp':
...
var _user$project$Dropdown_Common_View$highlight = function (pos) {
	return _user$project$Dropdown_Types$FocusStateMsg(
		_user$project$Dropdown_Types$Open(
			_user$project$Dropdown_Types$Highlight(pos)));
};
var _user$project$Dropdown_Common_View$isMenuOpen = function (_p0) {
	var _p1 = _p0;
	var _p2 = _p1.focusState;
	if (_p2.ctor === 'Open') {
		return true;
	} else {
		return false;
...
var _user$project$Dropdown_Common_View$boolString = function (bool) {
	return bool ? 'true' : 'false';
};
var _user$project$Dropdown_Common_View$handleContainerClick = function (_p3) {
	var _p4 = _p3;
	var _p5 = _p4.focusState;
	switch (_p5.ctor) {
		case 'Blurred':
			return _user$project$Dropdown_Types$FocusStateMsg(
				_user$project$Dropdown_Types$Open(_user$project$Dropdown_Types$Initial));
		case 'Focused':
			return _user$project$Dropdown_Types$FocusStateMsg(
				_user$project$Dropdown_Types$Open(_user$project$Dropdown_Types$Initial));
		default:
			return _user$project$Dropdown_Types$FocusStateMsg(_user$project$Dropdown_Types$Blurred);
	}
};
var _user$project$Dropdown_Common_View$handleContainerFocus = function (_p6) {
	var _p7 = _p6;
	var _p8 = _p7.focusState;
	if (_p8.ctor === 'Blurred') {
		return _user$project$Dropdown_Types$FocusStateMsg(_user$project$Dropdown_Types$Focused);
	} else {
		return _user$project$Dropdown_Types$NoOp;
	}
};
var _user$project$Dropdown_Common_View$handleDescendantGainingFocus = 'if (event.relatedTarget && this.contains(event.relatedTarget)) { event.stopImmediatePropagation(); }';
var _user$project$Dropdown_Common_View$view = F4(
	function (methods, config, model, selection) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(
					A2(_elm_lang$core$Basics_ops['++'], 'elm-dropdown ', methods.cssClass)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('elm-dropdown--container'),
						_1: {
							ctor: '::',
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: A2(_elm_lang$html$Html_Attributes$attribute, 'aria-haspopup', 'listbox'),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html_Attributes$attribute,
											'aria-expanded',
											_user$project$Dropdown_Common_View$boolString(
												_user$project$Dropdown_Common_View$isMenuOpen(model))),
										_1: {
											ctor: '::',
											_0: A2(_elm_lang$html$Html_Attributes$attribute, 'onfocusout', _user$project$Dropdown_Common_View$handleDescendantGainingFocus),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onFocus(
													_user$project$Dropdown_Common_View$handleContainerFocus(model)),
												_1: {
													ctor: '::',
													_0: A2(
														_elm_lang$html$Html_Events$on,
														'focusout',
														_elm_lang$core$Json_Decode$succeed(
															_user$project$Dropdown_Types$FocusStateMsg(_user$project$Dropdown_Types$Blurred))),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(
															_user$project$Dropdown_Common_View$handleContainerClick(model)),
														_1: {ctor: '[]'}
													}
												}
											}
					...
					{
						ctor: '::',
						_0: A2(methods.placeholder, config, selection),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('elm-dropdown--list'),
									_1: {
										ctor: '::',
										...
										_1: {
											...
											_0: A2(
												_elm_lang$html$Html_Attributes$attribute,
												'aria-label',
												config.selectionString(selection)),
											_1: {ctor: '[]'}
										}
									}
								},
								A3(methods.items, config, model, selection)),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
...
var _user$project$Dropdown_Single_View$optionView = F5(
	function (config, model, selection, pos, option) {
		return A2(
			_elm_lang$html$Html$li,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('single-select-option'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$tabindex(-1),
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$html$Html_Attributes$attribute, 'role', 'option'),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html_Attributes$attribute,
								'aria-label',
								config.optionString(option)),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html_Attributes$attribute,
									'aria-selected',
									_user$project$Dropdown_Common_View$boolString(
										A2(config.isSelected, option, selection))),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onMouseEnter(
										_user$project$Dropdown_Common_View$highlight(pos)),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$Dropdown_Types$SelectMsg(option)),
										_1: {ctor: '[]'}
									}
								}
							}
			...
			{
				ctor: '::',
				_0: config.optionHtml(option),
				_1: {ctor: '[]'}
			});
	});
var _user$project$Dropdown_Single_View$itemView = F4(
	function (config, model, selection, pos) {
		var _p0 = _user$project$Dropdown_Zipper$currentItem(pos);
		if (_p0.ctor === 'Option') {
			return A5(_user$project$Dropdown_Single_View$optionView, config, model, selection, pos, _p0._0);
		} else {
			return A6(_user$project$Dropdown_Single_View$groupView, config, model, selection, pos, _p0._0, _p0._1);
		}
	});
var _user$project$Dropdown_Single_View$groupView = F6(
	function (config, model, selection, pos, group, items) {
		return A2(
			_elm_lang$html$Html$li,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('single-select-group'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: config.groupHtml(group),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$ul,
...
var _user$project$Dropdown_Single_View$selectAll = F2(
	function (config, model) {
		return _elm_lang$html$Html$text('');
	});
var _user$project$Dropdown_Single_View$search = F2(
	function (config, model) {
		return _elm_lang$html$Html$text('');
	});
var _user$project$Dropdown_Single_View$placeholder = F2(
	function (config, selection) {
		return A2(
			...
			{
				ctor: '::',
				_0: config.selectionHtml(selection),
				_1: {ctor: '[]'}
			});
	});
var _user$project$Dropdown_Single_View$viewMethods = {cssClass: 'single-select', placeholder: _user$project$Dropdown_Single_View$placeholder, search: _user$project$Dropdown_Single_View$search, selectAll: _user$project$Dropdown_Single_View$selectAll, items: _user$project$Dropdown_Single_View$items};

var _user$project$Dropdown_Single_Update$updateMethods = {closeOnSelect: true};
...
var _user$project$Dropdown_Single$simpleConfig = function (optionString) {
	return {
		optionHtml: function (_p0) {
			return _elm_lang$html$Html$text(
				optionString(_p0));
		},
		optionString: optionString,
		groupHtml: _elm_lang$core$Basics$always(
			_elm_lang$html$Html$text('')),
		groupString: _elm_lang$core$Basics$always(''),
		selectionHtml: function (_p1) {
			return _elm_lang$html$Html$text(
				optionString(_p1));
		},
...
var _user$project$Dropdown_Single_Example$states = {
	ctor: '::',
	_0: {abbrev: 'MA', name: 'Massachusetts'},
	_1: {
		ctor: '::',
		_0: {abbrev: 'NY', name: 'New York'},
		_1: {
			ctor: '::',
			_0: {abbrev: 'WY', name: 'Wyoming'},
			_1: {ctor: '[]'}
		}
	}
};
...
var _user$project$Dropdown_Single_Example$State = F2(
	function (a, b) {
...
var _user$project$Dropdown_Single_Example$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				_user$project$Dropdown_Single_Example$MenuMsg,
				A3(_user$project$Dropdown_Single$view, _user$project$Dropdown_Single_Example$config, model.menuModel, model.selectedItem)),
			_1: {ctor: '[]'}
		});
};
var _user$project$Dropdown_Single_Example$main = _elm_lang$html$Html$beginnerProgram(
	{
		model: {
